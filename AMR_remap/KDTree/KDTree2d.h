...
typedef struct {
   ...
   boolean tree_built;
   int tree_size;
   TBounds2d* tree_safety_boxes;
   int * tree_link;
} TKDTree2d;

extern void KDTree_Initialize2d(TKDTree2d *t);
extern void KDTree_Destroy2d(TKDTree2d* t);
extern void KDTree_AddElement2d(TKDTree2d* t, TBounds2d* add);
extern void KDTree_CreateTree2d(TKDTree2d* t);
extern void KDTree_QueryBoxIntersect2d(TKDTree2d* t,
